        ...
        <div
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg mt-5 overflow-auto">
                <div
                    ...
                    <!-- <div>
                        <button type="button"
                            class="cursor-pointer focus:outline-none text-xs text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 font-medium rounded-lg px-5 py-2.5 me-2">
                            <i class="fa-solid fa-rotate-right me-1"></i>Restore
                        </button>
                        <button type="button"
                            class="cursor-pointer focus:outline-none text-xs text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800 font-medium rounded-lg px-5 py-2.5 me-2">
                            <i class="fa-solid fa-trash me-1"></i>Delete
                        </button>
                    </div> -->
                </div>
                <div class="p-5 px-7">
                    <table id="archive-table" class="table w-full text-gray-900 dark:text-gray-100">
                        <thead>
                            <tr>
                                <th>
